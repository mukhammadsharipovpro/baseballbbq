...
import BaseballBBQCartItemComponent from '../components/BaseballBBQCartItemComponent';
import BaseballBBQComponent from '../components/BaseballBBQComponent';
...
export default function () {
  ...
  const handleOrder = () => {
    const destinationScreen = cart.length
      ? 'BaseballBBQCartSuccessScreen'
      : 'BaseballBBQHomeScreen';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <BaseballBBQCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
